...
// appliqué sur n'importe quelle classe du package tn.enicarthage.services, sans tenir compte du type de retour ou des paramètres de la méthode.
...
@After("execution(* tn.enicarthage.services.*.*(..))")
